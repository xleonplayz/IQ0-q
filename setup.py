...
setup(
    ...
    # Explicitly specify which packages to include (this fixes the "Multiple top-level packages discovered" error)
    packages=find_packages(include=['simos_nv_simulator', 'simos_nv_simulator.*']),
    classifiers=[
