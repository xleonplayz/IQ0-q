...
class NVSimDebugLogic(QtCore.QObject):
    ...
    def _update_state(self):
        ...
        try:
            ...
            # Microwave state
            state['mw_frequency'] = self._nv_simulator._shared_state['current_mw_frequency']
            state['mw_power'] = self._nv_simulator._shared_state['current_mw_power']
            state['mw_on'] = self._nv_simulator._shared_state['current_mw_on']
            
            # Laser state
            state['laser_power'] = self._nv_simulator._shared_state['current_laser_power']
            state['laser_on'] = self._nv_simulator._shared_state['current_laser_on']
            
            # Scan state
            state['scanning_active'] = self._nv_simulator._shared_state['scanning_active']
            state['scan_index'] = self._nv_simulator._shared_state['current_scan_index']
            state['scan_frequencies'] = self._nv_simulator._shared_state['scan_frequencies']
            
            # Physics parameters
            if hasattr(self._nv_simulator, 'nv_model'):
